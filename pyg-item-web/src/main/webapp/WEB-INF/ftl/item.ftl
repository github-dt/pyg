									  ...
									  <#list s.attributeValue as item>
										 <dd>
											 <a href="javascript:;"
                                                ...
                                                ng-click="selectSpec('${s.attributeName}','${item}');"
                                             >
												 ${item}
						...
						<div class="summary-wrap">
							<div class="fl title">
								<div class="control-group">
									<div class="controls">
										<input autocomplete="off" type="text" value="{{num}}" class="itxt" />
                            ...
                            <div class="fl">
								<ul class="btn-choose unstyled">
									<li>
										<a href="#" target="_blank" class="sui-btn
										   btn-danger addshopcar" ng-click="addToCart();">加入购物车</a>
									</li>
								</ul>
							</div>
						</div>
